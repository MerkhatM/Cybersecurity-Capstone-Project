...
const CostCard = () => {
    ...
    const addCardBlock = () => {
        setCardBlocks([
            ...cardBlocks,
            { title: 'Покупки', img: 'https://w7.pngwing.com/pngs/34/771/png-transparent-computer-icons-retail-supermarket-shopping-retail-white-text-rectangle.png', price: 'Balance' },
        ]);
    };
